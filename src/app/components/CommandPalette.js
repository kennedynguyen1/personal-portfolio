  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e) => {
      ...
      if (key === "h") {
        ...
        e.preventDefault();
        runCommand(() => window.open("https://x.com/kennedynguyen1", "_blank"));
      } else if (key === "l") {
        e.preventDefault();
        runCommand(() =>
          window.open("https://www.linkedin.com/in/kennedy-nguyen/", "_blank")
        );
      } else if (key === "g") {
        e.preventDefault();
        runCommand(() => window.open("https://github.com/kennedynguyen1", "_blank"));
      } else if (key === "e") {
        e.preventDefault();
        runCommand(() =>
          window.open("mailto:kennedynguyen@ucsb.edu", "_blank")
        );
      } else if (key === "c") {
        e.preventDefault();
        runCommand(() =>
          window.open("https://github.com/kennedynguyen1/personal-portfolio", "_blank")
        );
      } else if (key === "t") {
        e.preventDefault();
            ...
            <Command.List className="max-h-[300px] overflow-y-auto px-3 py-4">
              ...
              >
                <Command.Item
                  ...
                  onSelect={() =>
                    runCommand(() =>
                      window.open("https://x.com/kennedynguyen1", "_blank")
                    )
                  }
                  className="flex items-center gap-2 px-3 py-2 text-sm text-stone-600 dark:text-stone-400 rounded hover:bg-stone-100 dark:hover:bg-stone-800 cursor-pointer data-[selected=true]:bg-stone-100 dark:data-[selected=true]:bg-stone-800"
                >
                ...
                <Command.Item
                  ...
                  onSelect={() =>
                    runCommand(() =>
                      window.open(
                        "https://www.linkedin.com/in/kennedy-nguyen/",
                        "_blank"
                      )
                    )
                  }
                ...
                <Command.Item
                  ...
                  onSelect={() =>
                    runCommand(() =>
                      window.open("https://github.com/kennedynguyen1", "_blank")
                    )
                  }
                  className="flex items-center gap-2 px-3 py-2 text-sm text-stone-600 dark:text-stone-400 rounded hover:bg-stone-100 dark:hover:bg-stone-800 cursor-pointer data-[selected=true]:bg-stone-100 dark:data-[selected=true]:bg-stone-800"
                >
